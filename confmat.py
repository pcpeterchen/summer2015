...
def plot_confusion_matrix(cm, classes, title):
    ...
    pylab.text(0, 0, "0.579", fontsize = 24, horizontalalignment = 'center', color='white')
    pylab.text(0, 1, "0.246", fontsize = 24, horizontalalignment = 'center', color='white')
    pylab.text(1, 0, "0.175", fontsize = 24, horizontalalignment = 'center', color='white')
    pylab.text(1, 1, "0.0", fontsize = 24, horizontalalignment = 'center', color='black')
    pylab.show()
